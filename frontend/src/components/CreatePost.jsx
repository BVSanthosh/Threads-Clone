                    ...
                    <ModalBody pb={6}>
                        <FormControl>
                            <Textarea 
                                ...
                                value={postText}
                            />
                            <Text fontSize="xs" fontWeight="bold" textAlign={"right"} m={"1"} color={"gray.800"}>{remainingChars}/{MAX_CHAR}</Text>
                            <Input type="file" ref={imageRef} onChange={handleImageChange} hidden />
                            <BsFillImageFill style={{margin: "5px", cursor: "pointer"}} onClick={() => imageRef.current.click()} />
                        </FormControl>
